        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              ...
              <Link href="https://wa.me/91XXXXXXXXXX" aria-label="WhatsApp" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-amber hover:text-black transition-all text-white/60">
